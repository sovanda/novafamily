							...
							<h3><?php the_title(); ?></h3>		
								<div class="row">
									<div class="col-xs-12">
										...
										<p>At NOVA we are not just a team, we are a family.<br/>
										We have a lot of fun together and we enjoy collaborating with our clients and partners.</p>
								...
								<table width="266">
									...
									<tr>
										...
										<td>Full time</td>
										<td>Phnom Penh</td>
										<td><a href="#two" class="two">View job</a></td>
									</tr>
									<tr>
										<td>Office receptionist</td>
										<td>Full time</td>
										<td>Phnom Penh</td>
										<td><a href="#three" class="three">View job</a></td>
									</tr>
									<tr>
								...
								<div class="hide-file" id="one">	
									...
									•	Research and build relationships with new clients<br/>
									•	Make calls and send emails to follow up on leads<br/>
									•	Assist with pitches within the digital landscape<br/>
									•	Day-to-day contact with clients and internal stakeholders for digital work<br/>
									•	Assist the digital marketing consultant/strategist where necessary<br/> 
							    ...
							    <div class="hide-file" id="two">
									...
									•	Defining advertising budgets for the client<br/>
									•	Presenting findings of client meetings to the agency<br/>
									•	Presenting creative work to the client, including new business pitches<br/>
									•	Day-to-day administration duties and tasks<br/>
							    ...
							    <div class="hide-file" id="three">
									...
									•	Types memorandum, reports and other correspondences<br/>
									•	Records and checks all mails, documents and other confidential matters coming in and out office<br/>
									•	Maintains a departmental general control file of all correspondences and documents<br/>
									•	Attends to any travel requirement<br/>
									•	Takes down minutes of meetings<br/>
									...
									•	Excellent knowledge of MS Office Applications; Word, Excel, PowerPoint & Outlook<br/>
									•	Knowledge of operating other standard office equipment<br/>
									•	Excellent ability to effectively and efficiently handle multiple, simultaneous, and complex tasks and projects<br/>
									•	Excellent command of the English Language, both orally and in writing<br/>
									•	Has mastered professional business ethics & inter-personal skills<br/>
							    ...
							    <div class="hide-file" id="four">
									...
									•	Make calls and send emails to follow up on leads<br/>
									•	Day-to-day contact with clients and internal resources<br/>
									•	Attend meetings with businesses and report on status meetings<br/>
	...
	<script type="text/javascript">
		jQuery(document).ready(function($){
          ...
          // Show chosen div, and hide all others
	        ...
	        {
	            //e.preventDefault();
	            $("#" + $(this).attr("class")).show().siblings('.hide-file').hide();
	        });
		});
	</script>
